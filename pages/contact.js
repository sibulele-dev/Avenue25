          ...
          <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
            <div className="flex flex-col justify-between">
              <div>
                ...
                <div className="text-gray-700 mt-8">
                  ...
                  <a
                    ...
                    href="mailto:info@avenue25.co.za"
                  >
                    email
                  </a>{" "}
                  instead.
              ...
              <div className="mt-8 text-center">
                <img
                  className="hidden md:block h-[28rem]"
                  src="https://ik.imagekit.io/knqnox49e/options_dOGT6nF1Z.png?ik-sdk-version=javascript-1.4.3&updatedAt=1661166859877"
                  alt="Lady with options"
                />
              </div>
            </div>
